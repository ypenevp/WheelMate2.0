...
//                 {[
//                     { icon: 'tablet-landscape', lib: 'ionicons', color: '#3b82f6', bg: '#dbeafe', title: 'Monitoring', desc: 'Live wheelchair data.', route: 'Monitoring' },
//                     { icon: 'location', lib: 'ionicons', color: '#22c55e', bg: '#dcfce7', title: 'Map & Navigation', desc: 'Real-time GPS navigation and accessible routing.', route: 'Map' },
...
export default function Home() {
    ...
    // Quick Access menu array. To hide the 'Activity Logs' from logged-out users, 
    // change `show: true` to `show: !!user` (or whatever logic defines a logged-in state).
    const quickAccessMenu = [
        { icon: 'tablet-landscape', lib: 'ionicons', color: '#3b82f6', bg: '#dbeafe', title: 'Monitoring', desc: 'Live wheelchair data.', route: 'Monitoring', show: true },
        { icon: 'location', lib: 'ionicons', color: '#22c55e', bg: '#dcfce7', title: 'Map & Navigation', desc: 'Real-time GPS navigation and accessible routing.', route: 'Map', show: true },
        { icon: 'people', lib: 'ionicons', color: '#8b5cf6', bg: '#ede9fe', title: 'Add Relatives', desc: 'Manage your connections and emergency contacts.', route: 'RelativesCareTakers', show: true },
        { icon: 'time', lib: 'ionicons', color: '#f59e0b', bg: '#fef3c7', title: 'Activity Logs', desc: 'Log of getting in and out of the wheelchair.', route: 'ActivityLogs', show: true }, // Hardcoded to true for now
    ];
    ...
    return (
        ...
        >
            ...
            <View style={{ paddingHorizontal: 20, marginTop: 32 }}>
                ...
                {quickAccessMenu.filter(item => item.show).map((item, i) => (
                    <TouchableOpacity
                        key={i}
                        activeOpacity={0.75}
                        onPress={() => navigation.navigate(item.route)}
